...
function App() {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center flex-col px-8"
      style={{ backgroundImage: `url('/back.jpeg')`, backgroundSize: "cover" }}
    >
      <span className="absolute top-4 rotate-5 text-lg font-semibold uppercase p-2  bg-green-300/60 rounded-full">
        Todo App by Alisha Saif
      </span>
      <div className="bg-white/60 shadow-lg w-full md:w-4/5 p-6 space-y-6 rounded-xl text-gray-600 duration-200">
        ...
        <form action={addTask} className="flex gap-2">
          ...
          <button className="bg-white rounded-md p-2 text-4xl cursor-pointer">
            +
          </button>
        </form>
